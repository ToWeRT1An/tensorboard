...
from tensorboard.plugins.bar import metadata
from tensorboard.plugins.bar import summary_v2


# Export V2 versions.
bar = summary_v2.bar
bar_pb = summary_v2.bar_pb
...
def op(name,
  ...
  with tf.name_scope(name):
    ...
    return tf.summary.tensor_summary(name='bar_summary',
                                     tensor=tensor,
